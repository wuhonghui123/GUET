...
public class DispatcherServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            //obj = BeanFactory.getInstance().getBean(controllerClassName);//老师自己实现的IoC
            //obj = controllerClass.newInstance();
            ServletContext ctx=getServletContext();
            ApplicationContext context= WebApplicationContextUtils.getWebApplicationContext(ctx);
            obj=context.getBean(StringUtils.uncapitalize(controllerClassName),controllerClass);
